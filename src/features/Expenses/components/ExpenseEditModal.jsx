        ...
        >
            <div className="bg-white rounded-lg p-4 w-full max-w-md" onClick={e => e.stopPropagation()}>
                <div className="flex items-center justify-between mb-3">
                    <h3 id="edit-expense-modal-title" className="text-base font-semibold">
                        {editedExpense.isOneOff ? 'Edit One-Off Expense' : 'Edit Expense'}
                    </h3>
                    <button className="p-2 rounded hover:bg-gray-100" onClick={onClose} aria-label="Close modal"><X className="w-4 h-4" /></button>
                </div>
